...
export default function AboutUs() {
  return (
    <main className='w-full max-w-7xl place-self-center flex flex-col gap-20 sm:gap-28 md:gap-36' style={{ fontFamily: 'Raleway, sans-serif' }}>
      {/* Hero Section */}
      <section className="relative w-full h-[450px] mt-12">
        <div className="relative w-full h-full rounded-3xl overflow-hidden shadow-xl">
          <Image
            ...
            priority
          />
          <div className="absolute inset-0 bg-black-overlay z-10"></div>
          <div className="absolute inset-0 flex flex-col justify-center items-center text-center text-white z-20 p-8">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">About Moon Navigation and Trading Co.</h1>
            <p className="text-lg md:text-xl max-w-3xl">Your trusted partner in global maritime logistics and trade solutions.</p>
          </div>
        </div>
      </section>

      {/* Main content section: Who are we? */}
      <section className="w-full max-w-6xl mx-auto flex flex-col md:flex-row gap-12 px-4 md:px-0 items-center">
      ...
      <section
        className="w-full flex justify-center items-center my-20 rounded-2xl overflow-hidden shadow-lg"
        style={{
          minHeight: 650,
      ...
      <section className="w-full max-w-7xl mx-auto mt-24 mb-20 px-4">
      ...
      <section className="w-full max-w-7xl mx-auto px-4 my-20 flex flex-col items-start">
