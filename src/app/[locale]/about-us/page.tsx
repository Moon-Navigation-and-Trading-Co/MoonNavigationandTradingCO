  ...
  return (
    <main className='w-full max-w-7xl place-self-center' style={{ fontFamily: 'Raleway, sans-serif' }}>
      ...
      >
        ...
        <div className="w-full max-w-6xl flex flex-col md:flex-row gap-10 mt-12 px-4 md:px-0">
          ...
          <div className="flex-1 flex flex-col justify-center">
            <h2 className="text-lg md:text-xl mb-3 text-[#23294d]" style={{ fontWeight: 400 }}>
              Who are we?
            </h2>
            <p className="text-[#23294d] text-sm md:text-base mb-3" style={{ fontWeight: 400 }}>
            ...
            <p className="text-[#23294d] text-sm md:text-base" style={{ fontWeight: 400 }}>
      ...
      <div className="w-full max-w-6xl flex flex-col md:flex-row gap-10 mt-16 px-4 md:px-0 items-center">
        ...
        <div className="flex-1 flex flex-col justify-center">
          <h3 className="text-base md:text-lg mb-3 text-[#3B4B8C]" style={{ fontWeight: 500 }}>
            Our Foundation – 2010
          </h3>
          <p className="text-[#23294d] text-sm md:text-base mb-3" style={{ fontWeight: 400 }}>
      ...
      <section className="w-full max-w-7xl mx-auto mt-20 px-4">
        <div className="border-b border-gray-200 pb-8">
          <h2 className="text-3xl md:text-4xl font-bold text-[#23294d] mb-3" style={{ fontFamily: 'Raleway, sans-serif' }}>
            Our Services
          </h2>
          <p className="text-[#23294d] text-base md:text-lg mb-8" style={{ fontFamily: 'Raleway, sans-serif', opacity: 0.85 }}>
          ...
          <div className="flex flex-wrap gap-6">
            <button className="bg-[#3B4B8C] text-white rounded-full px-8 py-3 text-base font-medium shadow-md hover:bg-[#23294d] transition">
        ...
        <div className="flex flex-col md:flex-row items-center gap-10 mt-16 border-b border-gray-200 pb-12">
          {/* Left: Text */}
          <div className="flex-1">
            <h3 className="text-2xl md:text-3xl font-bold text-[#23294d] mb-6" style={{ fontFamily: 'Raleway, sans-serif' }}>
              Efficient Transportation & Freight Solutions
            </h3>
            <p className="text-[#23294d] text-base md:text-lg mb-4" style={{ fontFamily: 'Raleway, sans-serif', opacity: 0.85 }}>
   ...
   <div className="flex flex-col md:flex-row items-center gap-10 mt-16 border-b border-gray-200 pb-12">
     ...
     <div className="flex-shrink-0 w-full md:w-[420px] rounded-2xl overflow-hidden mb-6 md:mb-0">
       <img
         src="/public/ship-agency-workers.jpg"
   ...
   <div className="flex flex-col md:flex-row items-center gap-10 mt-16 border-b border-gray-200 pb-12">
     ...
     <div className="flex-shrink-0 w-full md:w-[440px] rounded-2xl overflow-hidden mb-6 md:mb-0">
       <img
         src="/public/vessel-support-maintenance.jpg"
   ...
   <div className="flex flex-col md:flex-row items-center gap-10 mt-16">
     {/* Left: Text */}
     <div className="flex-1 mb-6 md:mb-0">
       <h3 className="text-2xl md:text-3xl font-bold text-[#23294d] mb-4" style={{ fontFamily: 'Raleway, sans-serif' }}>
         Other Logistic Services
       </h3>
       <p className="text-[#23294d] text-base md:text-lg mb-4" style={{ fontFamily: 'Raleway, sans-serif', opacity: 0.85 }}>
       ...
       <p className="text-[#23294d] text-base md:text-lg mb-2" style={{ fontFamily: 'Raleway, sans-serif', opacity: 0.85 }}>
       ...
       <p className="text-[#23294d] text-base md:text-lg mb-6" style={{ fontFamily: 'Raleway, sans-serif', opacity: 0.85 }}>
     ...
     <div className="flex-shrink-0 w-full md:w-[340px] rounded-2xl overflow-hidden">
       <img
         src="/other-logistics-services.jpg"
   ...
   <div className="w-full max-w-7xl mx-auto mt-24 mb-20">
     <h2 className="text-2xl md:text-3xl font-semibold text-[#3B4B8C] mb-2" style={{ fontFamily: 'Raleway, sans-serif' }}>
       Our Core Values: The Foundation of Excellence
     </h2>
     <p className="text-[#23294d] text-base md:text-lg mb-8 max-w-3xl" style={{ fontFamily: 'Raleway, sans-serif', opacity: 0.85 }}>
     ...
     <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
       ...
       <div className="relative rounded-2xl overflow-hidden shadow-md min-h-[200px] flex items-end bg-[#f5f7fa]">
         <img
           src="/core-values-integrity.jpg"
       ...
       <div className="relative rounded-2xl overflow-hidden shadow-md min-h-[200px] flex items-end bg-[#eaf0fa]">
         <img
           src="/core-values-customer.jpg"
       ...
       <div className="relative rounded-2xl overflow-hidden shadow-md min-h-[200px] flex items-end bg-[#f5f7fa]">
         <img
           src="/core-values-innovation.jpg"
   ...
   <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
     {/* Collaboration */}
     <div className="relative rounded-[2rem] overflow-hidden shadow-md min-h-[200px] flex items-end bg-[#eaf0fa]">
       <img
         src="/core-values-collaboration.jpg"
         alt="Collaboration"
         className="absolute inset-0 w-full h-full object-cover opacity-80"
     ...
     {/* Sustainability */}
     <div className="relative rounded-[2rem] overflow-hidden shadow-md min-h-[200px] flex items-end bg-[#f5f7fa]">
       <img
         src="/core-values-sustainability.jpg"
         alt="Sustainability"
         className="absolute inset-0 w-full h-full object-cover opacity-80"
         style={{ borderRadius: '2rem' }}
       />
   ...
   <div className="w-full flex flex-col md:flex-row items-center justify-center gap-10 mt-20">
     ...
     <div className="flex-1 max-w-3xl">
       <h2 className="text-2xl md:text-3xl font-semibold mb-2 text-[#23294d]" style={{ fontFamily: 'Raleway, sans-serif' }}>
       ...
       <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
         {/* ISO 9001 */}
         <div>
           <h3 className="text-lg font-bold mb-1 text-[#3B4B8C]">ISO 9001</h3>
           <p className="text-sm font-medium mb-2 text-[#23294d]">Quality Management</p>
         ...
         {/* ISO 14001 */}
         <div>
           <h3 className="text-lg font-bold mb-1 text-[#3B4B8C]">ISO 14001</h3>
           <p className="text-sm font-medium mb-2 text-[#23294d]">Environmental Responsibility</p>
           <p className="text-sm text-muted-foreground">
   ...
   <div className="w-full flex flex-col items-center mt-16">
     <div className="w-full max-w-5xl">
       ...
       <div className="flex flex-row flex-wrap items-center gap-6 justify-start">
         ...
         />
         <img
           src="/cert-iso9001-2008.png"
           alt="ISO 9001:2008"
           className="h-12 w-auto"
           style={{ maxWidth: '60px' }}
         />
         <img
           src="/cert-iso14001.png"
           alt="ISO 14001"
           className="h-12 w-auto"
           style={{ maxWidth: '60px' }}
         />
         ...
         />
         <img
           src="/cert-jas-anz.png"
           alt="JAS-ANZ"
           className="h-12 w-auto"
           style={{ maxWidth: '60px' }}
         />
         <img
           src="/cert-jas-anz-g.png"
           alt="JAS-ANZ G"
           className="h-12 w-auto"
           style={{ maxWidth: '60px' }}
         />
         <img
           src="/cert-vesseltracker.png"
           alt="Vesseltracker"
           className="h-12 w-auto"
           style={{ maxWidth: '90px' }}
         />
         <img
           src="/cert-maritime-sector.png"
   ...
   <div className="relative w-full min-h-[420px] flex items-center justify-center mb-16 mt-10">
     {/* Background image */}
     <img
       src="/about-hero-businessman.jpg"
     ...
     <div
       className="absolute inset-0 bg-[#23407a] z-10 "
       style={{ opacity: 0.68 }}
     />
     {/* Content */}
   ...
   <div className="relative w-full flex flex-col md:flex-row items-center justify-center my-16">
     ...
     <div className="w-full md:w-1/2 flex justify-center items-center">
       <img
         src="/about-partner-understands.jpg"
     ...
     <div className="w-full md:w-1/2 flex justify-center items-center px-4 md:px-10 mt-8 md:mt-0">
       <div className="bg-white/80 rounded-xl shadow-md p-6 md:p-10 max-w-lg">
         <h2 className="text-lg md:text-2xl font-semibold text-[#23407a] mb-3">
         ...
         <ul className="list-disc pl-5 text-sm md:text-base text-gray-700 space-y-1 mb-4">
         ...
         <div className="text-xs text-right text-gray-500 mt-4 italic">
   ...
   <div className="w-full max-w-6xl mx-auto my-20 px-4">
     <h2 className="text-center text-base md:text-lg font-semibold text-[#23407a] mb-2">
       Industry Expertise | Strategic Location | End-to-End Solutions
     </h2>
     <p className="text-center text-xs md:text-sm text-gray-700 mb-10 max-w-3xl mx-auto">
     ...
     <div className="grid grid-cols-1 md:grid-cols-3 gap-10 text-center">
       <div>
         <h3 className="font-semibold text-sm md:text-base text-[#23407a] mb-2">Industry Expertise</h3>
         <p className="text-xs md:text-sm text-gray-600">
           Experience in navigating the intricacies of maritime and logistics operations for reliable results.
         </p>
       </div>
       <div>
         <h3 className="font-semibold text-sm md:text-base text-[#23407a] mb-2">Strategic Location</h3>
         <p className="text-xs md:text-sm text-gray-600">
           Based in Egypt, with unparalleled access to the Suez Canal and regional seaports, making us a high-impact choice.
         </p>
       </div>
       <div>
         <h3 className="font-semibold text-sm md:text-base text-[#23407a] mb-2">End-to-End Solutions</h3>
         <p className="text-xs md:text-sm text-gray-600">
     ...
     <div className="grid grid-cols-1 md:grid-cols-3 gap-10 text-center mt-10">
       <div>
         <h3 className="font-semibold text-sm md:text-base text-[#23407a] mb-2">Global Reach</h3>
         <p className="text-xs md:text-sm text-gray-600">
           Established networks with international partners ensure smooth cross-border operations.
         </p>
       </div>
       <div>
         <h3 className="font-semibold text-sm md:text-base text-[#23407a] mb-2">Tailored Services</h3>
         <p className="text-xs md:text-sm text-gray-600">
           Our solutions are designed across your most important business needs, offering flexibility and efficiency.
         </p>
       </div>
       <div>
         <h3 className="font-semibold text-sm md:text-base text-[#23407a] mb-2">Sustainability Commitment</h3>
         <p className="text-xs md:text-sm text-gray-600">
