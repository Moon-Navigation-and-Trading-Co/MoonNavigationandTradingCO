...
const serviceFormRoutes: { [key: string]: string } = {
  ...
  "ship-management": "/vessel-support-maintenance-forms",
  "docking-maintenance": "/vessel-support-maintenance-forms",
  "handling-stevedoring": "/other-logistics-services-forms",
  "customs-clearance": "/other-logistics-services-forms",
