...
export default function ShippingMethodsInfo() {
    ...
    <div className="w-full mb-12">
      ...
      <div className="flex flex-col md:flex-row gap-8">
        <div className="flex-1 flex flex-col justify-start">
          <h2 className="text-lg md:text-xl font-medium text-[#222] mb-6" style={{ fontFamily: "Raleway, sans-serif" }}>
        ...
        <div className="flex-1">
          ...
          <p className="text-[#444] text-sm md:text-base" style={{ fontFamily: "Raleway, sans-serif" }}>
  ...
  <div className="w-full flex flex-col md:flex-row items-center justify-between rounded-[2rem] p-6 md:p-12 mb-12 shadow">
    ...
    <div className="w-full md:w-1/2 flex flex-col justify-center items-start px-0 md:px-8">
      ...
      <p className="text-[#444] text-xs md:text-sm mt-4" style={{ fontFamily: "Raleway, sans-serif" }}>
