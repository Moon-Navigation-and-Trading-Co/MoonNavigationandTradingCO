        ...
        <div className = "w-full max-w-7xl place-self-center" style={{ fontFamily: "Raleway, sans-serif" }}>
          ...
          <div className="flex flex-col md:flex-row items-start justify-between gap-8">
            <div className="w-full md:w-1/2">
              <h3 className="text-2xl  mb-4 text-primary dark:text-blue-400" style={{ fontFamily: "Raleway, sans-serif" }}>
                Request For a PDA
              </h3>
              <div>
            ...
            <div className="w-full md:w-1/2">
              <h4 className="text-lg  mb-2 text-primary dark:text-blue-400" style={{ fontFamily: "Raleway, sans-serif" }}>
                What Is Requesting for a PDA?
              </h4>
              <p className="text-base text-foreground mb-2" style={{ fontFamily: "Raleway, sans-serif" }}>
              ...
              <p className="text-base text-foreground" style={{ fontFamily: "Raleway, sans-serif" }}>
      ...
      renderServices={() => (
        <>
          <div className="w-full max-w-7xl mx-auto mt-16 mb-10 px-4">
            <h2 className="text-2xl  mb-2 text-primary dark:text-blue-400" style={{ fontFamily: "Raleway, sans-serif" }}>
              Key Components of Our PDA
            </h2>
            <p className="text-base text-foreground mb-8" style={{ fontFamily: "Raleway, sans-serif" }}>
          ...
          <div className="w-full flex flex-col md:flex-row items-center justify-center gap-10 mb-24">
            ...
            <div className="flex-1 max-w-xl">
              <h2 className="text-2xl  text-primary dark:text-blue-400 mb-3" style={{ fontFamily: "Raleway, sans-serif" }}>
                What We Provide
              </h2>
          ...
          <div className="w-full max-w-6xl mx-auto mb-24">
            <h2 className="text-xl md:text-2xl  text-primary dark:text-blue-400 mb-12 text-center" style={{ fontFamily: "Raleway, sans-serif" }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              ...
              <div className="flex flex-col items-center text-center">
                <h3 className="text-base  text-primary dark:text-blue-400 mb-2">Strong Relationships with Port Authorities</h3>
                <p className="text-foreground text-sm max-w-xs">
              ...
              <div className="flex flex-col items-center text-center">
                <h3 className="text-base  text-primary dark:text-blue-400 mb-2">Expert Ship Agency Services</h3>
                <p className="text-foreground text-sm max-w-xs">
              ...
              <div className="flex flex-col items-center text-center">
                <h3 className="text-base  text-primary dark:text-blue-400 mb-2">24/7 Support</h3>
                <p className="text-foreground text-sm max-w-xs">
