      ...
      renderServices={() => (
        <>
          ...
          <div className="w-full max-w-6xl mx-auto mb-24">
            <div className="w-full max-w-6xl mx-auto mb-24">
              <h2 className="text-2xl text-primary dark:text-blue-400 mb-3 text-left" style={{ fontFamily: 'Raleway, sans-serif' }}>
                What We Provide
              </h2>
              <p className="text-foreground text-sm mb-6 text-left" style={{ fontFamily: 'Raleway, sans-serif' }}>
