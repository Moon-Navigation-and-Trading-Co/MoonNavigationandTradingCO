...
export default function PDAProcessPage() {
  return (
    <div className="w-full max-w-6xl mx-auto py-12 px-4" style={{ fontFamily: "Raleway, sans-serif" }}>
      <h1 className="text-2xl md:text-3xl font-semibold text-[#2a4365] mb-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start mb-12">
        <div>
          <h2 className="text-lg font-bold text-[#2a4365] mb-2">Step 1: Pre-Arrival Cost Estimation</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
        ...
        <div className="order-1 md:order-2">
          <h2 className="text-lg font-bold text-[#2a4365] mb-2">Step 2: Real-Time Adjustments & Updates</h2>
          <p className="text-[#444] mb-4">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start mt-12">
      <div>
        <h2 className="text-lg font-bold text-[#2a4365] mb-2">
        ...
        <p className="text-[#444] mb-2">
          Our team prepares the <span className="font-semibold">Final Disbursement Account</span> meticulously by verifying invoices and reconciling actual costs with the Port Disbursement Assessment.
        </p>
        <p className="text-[#444] mb-2">
