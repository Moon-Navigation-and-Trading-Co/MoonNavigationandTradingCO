                ...
                <div className="max-w-7xl mx-auto px-4 md:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        <div>
                            ...
                            <Button className="bg-[#3B4B8C] hover:bg-[#2d3a6d]">{t("hero.requestQuote")}</Button>
                        </div>
                ...
                <div className="max-w-7xl mx-auto px-4 md:px-8">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-8 mb-12">
                        <div className="md:w-1/2">
                            <p className="text-gray-600 leading-relaxed mb-4">{t("costManagement.firstParagraph1")}</p>
                ...
                <div className="max-w-7xl mx-auto px-4 md:px-8">
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full border-collapse">
                            <thead>
                                <tr className="border">
                                    <th className="p-4 text-left border">{t("shippingOptions.serviceType")}</th>
                                    <th className="p-4 text-left border">{t("shippingOptions.transitTime")}</th>
                                    <th className="p-4 text-left border">{t("shippingOptions.cargoType")}</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr className="border">
                                    <td className="p-4 border">{t("shippingOptions.express")}</td>
                                    <td className="p-4 border">{t("shippingOptions.sameDay")}</td>
                                    <td className="p-4 border">{t("shippingOptions.highValue")}</td>
                                </tr>
                                <tr className="border">
                                    <td className="p-4 border">{t("shippingOptions.standard")}</td>
                                    <td className="p-4 border">{t("shippingOptions.days1")}</td>
                                    <td className="p-4 border">{t("shippingOptions.generalCargo")}</td>
                                </tr>
                                <tr className="border">
                                    <td className="p-4 border">{t("shippingOptions.economy")}</td>
                                    <td className="p-4 border">{t("shippingOptions.days2")}</td>
                                    <td className="p-4 border">{t("shippingOptions.nonUrgent")}</td>
                                </tr>
                                <tr className="border">
                                    <td className="p-4 border">{t("shippingOptions.charter")}</td>
                                    <td className="p-4 border">{t("shippingOptions.custom")}</td>
                                    <td className="p-4 border">{t("shippingOptions.oversized")}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div className="mt-8">
                        <Link href="/learn/air-freight-special-cargo">
                            <Button variant="default" className="bg-[#3B4B8C] hover:bg-[#2d3a6d]">
                ...
                <div className="max-w-7xl mx-auto px-4 md:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                        ...
                        <div className="space-y-6">
                            ...
                            <p className="text-gray-600">{t("seaAir.subtitle")}</p>
                            <p className="text-gray-600">{t("seaAir.description")}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="w-full py-16 bg-white">
                <div className="max-w-7xl mx-auto px-4 md:px-8">
                    <div className="space-y-8">
                        ...
                        <p className="text-gray-600 leading-relaxed">{t("seaAir.singleSource")}</p>

                        <p className="text-gray-600 leading-relaxed">{t("seaAir.expertise")}</p>

                        <p className="text-gray-600 leading-relaxed">{t("seaAir.caption2")}</p>
                ...
                <div className="max-w-7xl mx-auto px-4 md:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="space-y-6">
                            ...
                            <p className="text-gray-600">{t("specializedServices.expertise")}</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-gray-600">{t("reasons.expertHandlingDesc")}</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-gray-600">{t("reasons.competitiveRatesDesc")}</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-gray-600">{t("reasons.customizedSolutionsDesc")}</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-gray-600">{t("reasons.supportDesc")}</p>
                            </div>
                        </div>
                    </div>
                </div>
