        ...
        <>
         <section className="w-full max-w-7xl mx-auto mt-16 mb-8 px-4">
                ...
                <section className="w-full justify-center mt-12 mb-8 place-items-center" style={{ fontFamily: 'Raleway, sans-serif' }}>
                    ...
                    >
                        <h2
                            className="text-primary md:text-[15px]  mb-4"
                            style={{
                        ...
                        <ul className="space-y-2 text-[11px] md:text-[13px] text-primary pl-0" style={{ fontFamily: 'Raleway, sans-serif' }}>
                            <li className="flex items-start">
                                ...
                                <span>
                                    <span className=" text-primary">Large but Manageable Weight and Size:</span> Our breakbulk cargo typically eclipses basic pallet and truck limits in both size and weight, allowing us to handle substantial sections with precision and care.
                                </span>
                            </li>
                            <li className="flex items-start">
                                <span className="text-[#222] mr-2" style={{ fontWeight: 600, fontSize: "13px" }}>✔</span>
                                <span>
                                    <span className=" text-primary">Loaded and Unloaded Piece by Piece:</span> Each item is loaded and unloaded piece by piece using external cranes, forklifts, or vessel lifting equipment, ensuring the utmost support from ground arrival to on-board stowage.
                                </span>
                            </li>
                            <li className="flex items-start">
                                <span className="text-[#222] mr-2" style={{ fontWeight: 600, fontSize: "13px" }}>✔</span>
                                <span>
                                    <span className=" text-primary">Transported on Breakbulk and Multi-Purpose Vessels (MPVs):</span> Our solutions utilize ships designed for specific cargo handling and flexible stowage configurations, accommodating various module and piece sizes.
                                </span>
                            </li>
                            <li className="flex items-start">
                                <span className="text-[#222] mr-2" style={{ fontWeight: 600, fontSize: "13px" }}>✔</span>
                            ...
                            <li className="flex items-start">
                                <span className="text-[#222] mr-2" style={{ fontWeight: 600, fontSize: "13px" }}>✔</span>
                                <span>
                                    <span className=" text-primary">Essential for Construction, Manufacturing, and Infrastructure Projects:</span> Our breakbulk cargo plays a vital role in supporting industries that require large-scale imports and transshipment of machinery, steel structures, pre-fabricated units, and more.
                                </span>
                            </li>
                        </ul>
                ...
                <section className="w-full max-w-[1600px] mx-auto mt-20 mb-10 px-4" style={{ fontFamily: 'Raleway, sans-serif' }}>
                    <h2 className="text-3xl md:text-4xl font-light text-[#3a4fcf] mb-16 text-left md:text-center" style={{ fontFamily: 'Raleway, sans-serif' }}>
