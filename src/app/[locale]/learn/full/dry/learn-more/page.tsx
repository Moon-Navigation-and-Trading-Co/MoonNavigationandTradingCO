      ...
      <div className="w-full max-w-7xl mx-auto mt-20 mb-12 px-4 md:px-0">
        ...
        <div className="flex flex-col gap-y-20">
          ...
          <div className="flex flex-col md:flex-row-reverse items-center gap-8">
            <div className="flex-1 flex flex-col items-start text-left justify-center">
              ...
              <ul className="list-disc pl-5 text-base text-gray-700 dark:text-gray-200 mb-4 text-left">
        ...
        <div className="w-full max-w-7xl flex flex-col md:flex-row items-center gap-12 mt-20 mb-12 px-2 md:px-0">
          <div className="flex-1 flex flex-col gap-4 items-center text-center justify-center">
            <h2 className="text-2xl md:text-3xl  text-[#23294d] dark:text-[#bfc8f8] mb-2">
