    ...
    <div className="w-full mt-10 mb-20 max-w-7xl mx-auto p-0 sm:p-5" style={{ fontFamily: 'Raleway, sans-serif' }}>
      ...
      <div className="flex flex-col md:flex-row gap-10 mt-12 items-center">
        ...
        <div className="flex-1 flex flex-col gap-4">
          ...
          <ul className="list-disc pl-5 text-sm text-muted-foreground space-y-2">
            ...
            <li>
              <span className="text-foreground">Spare Parts Management:</span> Timely sourcing and delivery of critical spares and technical equipment.
            </li>
            <li>
              <span className="text-foreground">Condition Monitoring:</span> Ongoing performance tracking of onboard machinery and systems.
            </li>
            <li>
              <span className="text-foreground">Regulatory Compliance:</span> Ensuring full compliance of vessel with class requirements and international regulations (ISM, MARPOL, SOLAS, etc).
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-10 mt-12 items-center">
        ...
        <div className="flex-1 flex flex-col gap-4">
          ...
          <ul className="list-disc pl-5 text-sm text-muted-foreground space-y-2">
            <li>
              <span className="text-foreground">Voyage Planning:</span> Optimized routing and scheduling for cost and time efficiency.
            </li>
            <li>
              <span className="text-foreground">Port Call Coordination:</span> Handling port clearances, agents, and berthing arrangements.
            </li>
            <li>
              <span className="text-foreground">Cargo Operations Support:</span> Ensuring safe and efficient cargo handling and documentation.
            </li>
            <li>
      ...
      <div className="flex flex-col md:flex-row gap-10 mt-12 items-center">
        ...
        <div className="flex-1 flex flex-col gap-4">
          ...
          <ul className="list-disc pl-5 text-sm text-muted-foreground space-y-2">
            ...
            <li>
              <span className="text-foreground">Inventory Control:</span> Stock level tracking to avoid shortages or overstocking.
            </li>
            <li>
              <span className="text-foreground">Vendor Management:</span> Evaluating suppliers to ensure quality and cost-efficiency.
            </li>
            <li>
              <span className="text-foreground">Logistics Coordination:</span> Global sourcing with end-to-end delivery management.
            </li>
          </ul>
        </div>
      ...
      <div className="flex flex-col md:flex-row gap-10 mt-12 items-center">
        ...
        <div className="flex-1 flex flex-col gap-4">
          ...
          <ul className="list-disc pl-5 text-sm text-muted-foreground space-y-2">
            <li>
              <span className="text-foreground">Planned Maintenance:</span> Schedules based on manufacturer guidelines and vessel operating hours.
            </li>
            <li>
              <span className="text-foreground">Condition-Based Monitoring:</span> Ongoing assessment of machinery performance to detect early signs of issues.
            </li>
            <li>
              <span className="text-foreground">Fault Diagnostics:</span> Predictive tools used to identify faults and reduce potential downtime.
            </li>
            <li>
              <span className="text-foreground">Maintenance Optimization:</span> Efficient planning to minimize costs and improve operational reliability.
            </li>
            <li>
              <span className="text-foreground">System Audit Routine:</span> Checks to ensure compliance with industry and manufacturer standards.
            </li>
            <li>
              <span className="text-foreground">Maintenance Records:</span> Detailed documentation for performance tracking and regulatory transparency.
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-10 mt-12 items-center">
        ...
        <div className="flex-1 flex flex-col gap-4">
          ...
          <ul className="list-disc pl-5 text-sm text-muted-foreground space-y-2">
            <li>
              <span className="text-foreground">Bunker Procurement:</span> Sourcing quality fuel at competitive rates from trusted suppliers.
            </li>
            <li>
            ...
            <li>
              <span className="text-foreground">Regulatory Compliance:</span> Adhering to fuel quality standards and IMO environmental rules.
            </li>
          </ul>
        </div>
      ...
      <div className="flex flex-col md:flex-row gap-10 mt-12 items-center">
        ...
        <div className="flex-1 flex flex-col gap-4">
          ...
          <ul className="list-disc pl-5 text-sm text-muted-foreground space-y-2">
            ...
            <li>
              <span className="text-foreground">SIRE and MARPOL Compliance:</span> SIRE implementation and monitoring.
            </li>
          </ul>
        </div>
      </div>
      <div className="flex flex-col md:flex-row gap-10 mt-12 items-center">
        ...
        <div className="flex-1 flex flex-col gap-4">
          ...
          <ul className="list-disc pl-5 text-sm text-muted-foreground space-y-2">
            <li>
              <span className="text-foreground">Operating Budget Planning:</span> Estimates costs for routine vessel operation.
            </li>
            <li>
              <span className="text-foreground">Monthly Reporting:</span> Detailed breakdown of expenditures, income, and cost.
            </li>
            <li>
              <span className="text-foreground">Cost Control Monitoring:</span> Usage and efficiency improvement assessment.
            </li>
            <li>
              <span className="text-foreground">Owner Reports:</span> Clear monthly updates on vessel financial performance.
            </li>
            <li>
              <span className="text-foreground">Forecasting Strategy:</span> Informed planning for future operations.
            </li>
            <li>
              <span className="text-foreground">Audit Support:</span> Assistance in internal and external financial audits.
            </li>
          </ul>
        </div>
      ...
      <div className="flex flex-col md:flex-row gap-10 mt-12 items-center">
        ...
        <div className="flex-1 flex flex-col gap-4">
          ...
          <ul className="list-disc pl-5 text-sm text-muted-foreground space-y-2">
            ...
            <li>
              <span className="text-foreground">Incident Documentation:</span> Preparing accurate and timely reports for insurers.
            </li>
            <li>
              <span className="text-foreground">Risk Assessment:</span> Proactive evaluation to minimize operational risks.
            </li>
            <li>
              <span className="text-foreground">Certificate Management:</span> Keeping all insurance and compliance documents up to date.
            </li>
          </ul>
        </div>
      </div>
      <div className="flex flex-col md:flex-row gap-10 mt-12 items-center">
        ...
        <div className="flex-1 flex flex-col gap-4">
          ...
          <ul className="list-disc pl-5 text-sm text-muted-foreground space-y-2">
            <li>
              <span className="text-foreground">Pre-Docking Planning:</span> Scope of work, budgeting, and yard selection.
            </li>
            <li>
              <span className="text-foreground">Onsite Supervision:</span> Close monitoring of dock work to ensure timeline and quality.
            </li>
            <li>
              <span className="text-foreground">Post-Docking Reports:</span> Full documentation and cost review for owners.
            </li>
            <li>
      ...
      <div className="flex flex-col md:flex-row gap-10 mt-12 items-center">
        ...
        <div className="flex-1 flex flex-col gap-4">
          ...
          <ul className="list-disc pl-5 text-sm text-muted-foreground space-y-2">
            ...
            <li>
              <span className="text-foreground">KPI Analysis:</span> Speed, fuel deviation, emissions, and other key metrics.
            </li>
            <li>
              <span className="text-foreground">Preventive Actions:</span> Identifying patterns and reducing risks early.
            </li>
          </ul>
        </div>
      </div>
      <div className="flex flex-col md:flex-row gap-10 mt-12 items-center">
        ...
        <div className="flex-1 flex flex-col gap-4">
          ...
          <p className="text-sm text-muted-foreground mb-2">
            Every ship and owner has unique needs. We offer tailored management services to suit individual requirements.
          </p>
          <ul className="list-disc pl-5 text-sm text-muted-foreground space-y-2">
            <li>
              <span className="text-foreground">Full or Partial Management Options:</span> Depending on your needs.
            </li>
            <li>
      ...
      <div className="flex flex-col md:flex-row gap-10 mt-12 items-center">
        ...
        <div className="flex-1 flex flex-col gap-4">
          ...
          <ul className="list-disc pl-5 text-sm text-muted-foreground space-y-2">
            ...
            <li>
              <span className=" text-foreground">Crisis Incident Assistance:</span> Technical and operational support to mitigate impact and restore safety.
            </li>
            <li>
              <span className=" text-foreground">Post-Incident Reporting:</span> Full documentation and analysis for regulatory and insurance compliance.
            </li>
          </ul>
        </div>
      </div>
