    ...
    <div className="min-h-screen flex flex-col items-center py-10 px-2 md:px-0">
      ...
      <div className="w-full max-w-7xl grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        <div className="flex flex-col items-start justify-start">
          ...
          <Button asChild className="bg-primary text-white px-6 py-2 rounded-lg shadow hover:bg-primary/90 mb-6">
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="flex flex-col md:flex-row justify-center gap-8 mb-4">
            ...
            <div className="flex-1 flex flex-col items-center">
              ...
              <span className="font-semibold text-center">Heavy machinery</span>
            ...
            <div className="flex-1 flex flex-col items-center">
              ...
              <span className="font-semibold text-center">Large industrial equipment</span>
            </div>
            ...
            <div className="flex-1 flex flex-col items-center">
              ...
              <span className="font-semibold text-center">Prefabricated construction materials</span>
            </div>
          </div>
          {/* Second row: 2 items */}
          <div className="flex flex-col md:flex-row justify-center gap-8">
            ...
            <div className="flex-1 flex flex-col items-center">
              ...
              <span className="font-semibold text-center">Wind turbine blades</span>
            ...
            <div className="flex-1 flex flex-col items-center">
              ...
              <span className="font-semibold text-center">Large pipes and metal structures</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="w-full max-w-7xl mx-auto mt-20 grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
        ...
        <div className="flex flex-col gap-4">
          <div className="w-full rounded-xl overflow-hidden shadow mb-4 order-2 md:order-1">
            <img
              src="/oversized-cargo-workers.jpg"
              alt="Workers planning oversized cargo loading"
              className="object-cover w-full h-32 md:h-36"
            />
          </div>
          ...
          <table className="min-w-full border border-gray-300 bg-background text-sm md:text-base">
            <thead>
              <tr className="bg-gray-100 dark:bg-gray-800">
                ...
                <th className="px-4 py-3 border-b border-gray-300 text-left font-semibold">Oversized Containers</th>
                <th className="px-4 py-3 border-b border-gray-300 text-left font-semibold">Standard Containers</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td className="px-4 py-3 border-b border-gray-200">Cargo Type</td>
                <td className="px-4 py-3 border-b border-gray-200">Heavy, irregular, and overlength goods</td>
                <td className="px-4 py-3 border-b border-gray-200">General dry cargo</td>
              </tr>
              <tr className="bg-gray-50 dark:bg-gray-900">
                <td className="px-4 py-3 border-b border-gray-200">Loading Method</td>
                <td className="px-4 py-3 border-b border-gray-200">Open side or top loading</td>
                <td className="px-4 py-3 border-b border-gray-200">Front loading only</td>
              </tr>
              <tr>
                <td className="px-4 py-3 border-b border-gray-200">Enclosure</td>
                <td className="px-4 py-3 border-b border-gray-200">Open type or open-sided</td>
                <td className="px-4 py-3 border-b border-gray-200">Fully enclosed</td>
              </tr>
              <tr className="bg-gray-50 dark:bg-gray-900">
                <td className="px-4 py-3 border-b border-gray-200">Weight Capacity</td>
                <td className="px-4 py-3 border-b border-gray-200">Up to 45+ tons (varies)</td>
                <td className="px-4 py-3 border-b border-gray-200">Up to 30+ tons (varies)</td>
              </tr>
              <tr>
                <td className="px-4 py-3 border-b border-gray-200">Stackability</td>
                <td className="px-4 py-3 border-b border-gray-200">Limited stacking</td>
                <td className="px-4 py-3 border-b border-gray-200">Fully stackable</td>
              </tr>
              <tr className="bg-gray-50 dark:bg-gray-900">
                <td className="px-4 py-3">Common Use</td>
                <td className="px-4 py-3">Machinery, construction, and project cargo</td>
                <td className="px-4 py-3">Retail, consumer goods, general freight</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <div className="w-full max-w-7xl mx-auto mt-20">
        ...
        <div className="overflow-x-auto rounded-lg shadow">
          <table className="min-w-full border border-gray-300 bg-white text-sm" style={{ fontFamily: 'Montserrat, sans-serif' }}>
            <thead>
              <tr className="bg-gray-50">
                <th className="px-4 py-3 border-b border-gray-300 text-left font-semibold">Container Type</th>
                <th className="px-4 py-3 border-b border-gray-300 text-left font-semibold">Max Length</th>
                <th className="px-4 py-3 border-b border-gray-300 text-left font-semibold">Max Width</th>
                <th className="px-4 py-3 border-b border-gray-300 text-left font-semibold">Max Height</th>
                <th className="px-4 py-3 border-b border-gray-300 text-left font-semibold">Max Weight</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td className="px-4 py-3 border-b border-gray-200">Flat Rack (20’)</td>
                <td className="px-4 py-3 border-b border-gray-200">5.94m (19.5 ft)</td>
                <td className="px-4 py-3 border-b border-gray-200">2.40m (7.9 ft)</td>
                <td className="px-4 py-3 border-b border-gray-200">No fixed height</td>
                <td className="px-4 py-3 border-b border-gray-200">~45,000 kg</td>
              </tr>
              <tr className="bg-gray-50">
                <td className="px-4 py-3 border-b border-gray-200">Flat Rack (40’)</td>
                <td className="px-4 py-3 border-b border-gray-200">12.05m (39.5 ft)</td>
                <td className="px-4 py-3 border-b border-gray-200">2.40m (7.9 ft)</td>
                <td className="px-4 py-3 border-b border-gray-200">No fixed height</td>
                <td className="px-4 py-3 border-b border-gray-200">~45,000 kg</td>
              </tr>
              <tr>
                <td className="px-4 py-3 border-b border-gray-200">Open Top (20’)</td>
                <td className="px-4 py-3 border-b border-gray-200">5.9m (19.4 ft)</td>
                <td className="px-4 py-3 border-b border-gray-200">2.35m (7.7 ft)</td>
                <td className="px-4 py-3 border-b border-gray-200">Up to 2.70m (8.9 ft)</td>
                <td className="px-4 py-3 border-b border-gray-200">~28,000 kg</td>
              </tr>
              <tr className="bg-gray-50">
                <td className="px-4 py-3 border-b border-gray-200">Open Top (40’)</td>
                <td className="px-4 py-3 border-b border-gray-200">12.03m (39.4 ft)</td>
                <td className="px-4 py-3 border-b border-gray-200">2.35m (7.7 ft)</td>
                <td className="px-4 py-3 border-b border-gray-200">Up to 2.95m (9.7 ft)</td>
                <td className="px-4 py-3 border-b border-gray-200">~26,000 kg</td>
              </tr>
              <tr>
                <td className="px-4 py-3 border-b border-gray-200">Platform (20’)</td>
                <td className="px-4 py-3 border-b border-gray-200">No fixed limit</td>
                <td className="px-4 py-3 border-b border-gray-200">No fixed limit</td>
                <td className="px-4 py-3 border-b border-gray-200">No fixed limit</td>
                <td className="px-4 py-3 border-b border-gray-200">Up to 50,000 kg</td>
              </tr>
              <tr className="bg-gray-50">
                <td className="px-4 py-3 border-b border-gray-200">Platform (40’)</td>
                <td className="px-4 py-3 border-b border-gray-200">No fixed limit</td>
                <td className="px-4 py-3 border-b border-gray-200">No fixed limit</td>
                <td className="px-4 py-3 border-b border-gray-200">No fixed limit</td>
                <td className="px-4 py-3 border-b border-gray-200">Up to 50,000 kg</td>
        ...
        <div className="text-xs md:text-sm text-gray-600 mt-2" style={{ fontFamily: 'Montserrat, sans-serif' }}>
