        ...
        <Card className="w-full mt-10 mb-20 max-w-4xl mx-auto p-0 sm:p-5">
            ...
            <CardContent className="space-y-6">
                ...
                <section>
                    ...
                    <ul className="list-disc pl-6 space-y-1">
                        <li><span className="font-bold">{t('list-3-title-1')}:</span> {t('list-3-description-1')} </li>
                        <li><span className="font-bold">{t('list-3-title-2')}:</span> {t('list-3-description-2')} </li>
                        <li><span className="font-bold">{t('list-3-title-3')}:</span> {t('list-3-description-3')} </li>
                    </ul>
                    <p className="mt-2">{t('description-3-bot')}</p>
                </section>

                <section>
                    <h2 className="text-xl font-semibold mb-4 text-primary">{t('sub-t-3')}:</h2>
                    <ol className="list-decimal pl-6 space-y-2">
                        <li><span className="font-bold">{t('list-4-title-1')}:</span> {t('list-4-description-1')} </li>
                        <li><span className="font-bold">{t('list-4-title-2')}:</span> {t('list-4-description-2')} </li>
                        <li><span className="font-bold">{t('list-4-title-3')}:</span> {t('list-4-description-3')} </li>
                        <li><span className="font-bold">{t('list-4-title-4')}:</span> {t('list-4-description-4')} </li>
                        <li><span className="font-bold">{t('list-4-title-5')}:</span> {t('list-4-description-5')} </li>
                        <li><span className="font-bold">{t('list-4-title-6')}:</span> {t('list-4-description-6')} </li>
                        <li><span className="font-bold">{t('list-4-title-7')}:</span> {t('list-4-description-7')} </li>
