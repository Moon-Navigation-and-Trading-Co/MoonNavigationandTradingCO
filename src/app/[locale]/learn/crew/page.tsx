...
compliance with maritime regulations and local port requirements. 
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center mt-16">
    {/* Left: Text Content */}
    <div>
      <h2 className="text-xl md:text-2xl  text-[#2a6db0] mb-4">
        Our sign-on onboarding authorities to secure necessary port entry passes:
      </h2>
      <div className="mb-6">
        <h3 className=" text-[#222] mb-1 text-base">Travel Arrangements</h3>
      ...
      <div className="mb-6">
        <h3 className=" text-[#222] mb-1 text-base">Port and Immigration Formalities</h3>
        <p className="text-[#444] text-sm mb-3">
      ...
      <div className="mb-8">
        <h3 className=" text-[#222] mb-1 text-base">Transportation to Vessel</h3>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center mt-16">
    ...
    <div className="order-2 md:order-2">
      ...
      <div className="mb-6">
        <h3 className=" text-[#222] mb-1 text-base">Customs and Immigration Clearance</h3>
        <p className="text-[#444] text-sm mb-3">
      ...
      <div className="mb-6">
        <h3 className=" text-[#222] mb-1 text-base">Transportation from Vessel</h3>
        <p className="text-[#444] text-sm mb-3">
      ...
      <div className="mb-8">
        <h3 className=" text-[#222] mb-1 text-base">Medical Assistance (if necessary)</h3>
        <p className="text-[#444] text-sm">
  ...
  <div className="w-full max-w-6xl mx-auto mt-20 mb-10 px-4">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-8">
      <div className="flex flex-col items-center text-center">
        <h3 className=" mb-2">24/7 Crew Change Support</h3>
        <p className="text-[#444] text-sm">
          Anytime, anywhere: meet your crew change needs.
        </p>
      </div>
      <div className="flex flex-col items-center text-center">
        <h3 className=" mb-2">Strict Compliance &amp; Safety Standards</h3>
        <p className="text-[#444] text-sm">
          We adhere to IMO, MLC, ISPS, and all flag state regulations.
        </p>
      </div>
      <div className="flex flex-col items-center text-center">
        <h3 className=" mb-2">Cost-Effective &amp; Efficient Solutions</h3>
        <p className="text-[#444] text-sm">
          Our strategies are designed to minimize vessel downtime and optimize crew.
        </p>
      </div>
      <div className="flex flex-col items-center text-center">
        <h3 className=" mb-2">Emergency Crew Change Capability</h3>
        <p className="text-[#444] text-sm">
