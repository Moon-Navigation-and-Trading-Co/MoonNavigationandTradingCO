    ...
    <div className="min-h-screen flex flex-col justify-center items-center py-8 px-4">
      ...
      <div className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
        ...
        <div className="flex flex-col justify-center items-start">
          ...
          <span className="text-lg text-[#3B409F] mb-6">(LCL)</span>
          <Link href="/container-services-forms" passHref>
        ...
        <div>
          <h2 className="text-xl font-semibold text-[#3B409F] mb-4">
      ...
      <div className="w-full max-w-5xl mt-16 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        {/* Left: Text */}
        <div>
          <h2 className="text-lg md:text-xl font-semibold text-[#3B409F] mb-3">
            When to use LCL?
          </h2>
      ...
      <div className="w-full max-w-5xl mt-20">
        <h2 className="text-xl md:text-2xl font-semibold text-[#3B409F] mb-6">
        ...
        <div className="overflow-x-auto rounded-2xl shadow-md">
          <table className="min-w-full bg-white border border-gray-200 text-sm md:text-base">
            <thead>
              <tr className="bg-[#f5f6fa] text-[#3B409F]">
                <th className="py-3 px-4 border-b font-semibold text-left">Feature</th>
                <th className="py-3 px-4 border-b font-semibold text-left">LCL (Less Than Container Load)</th>
                <th className="py-3 px-4 border-b font-semibold text-left">FCL (Full Container Load)</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td className="py-3 px-4 border-b">Cost</td>
                <td className="py-3 px-4 border-b">Lower (pay for used space)</td>
                <td className="py-3 px-4 border-b">Higher (pay for full container)</td>
              </tr>
              <tr className="bg-[#f9fafb]">
                <td className="py-3 px-4 border-b">Volume</td>
                <td className="py-3 px-4 border-b">Small to medium shipments</td>
                <td className="py-3 px-4 border-b">Larger shipments</td>
              </tr>
              <tr>
                <td className="py-3 px-4 border-b">Transit Time</td>
                <td className="py-3 px-4 border-b">Slightly longer (due to consolidation)</td>
                <td className="py-3 px-4 border-b">Faster (direct shipping)</td>
              </tr>
              <tr className="bg-[#f9fafb]">
                <td className="py-3 px-4 border-b">Flexibility</td>
                <td className="py-3 px-4 border-b">More frequent shipments</td>
                <td className="py-3 px-4 border-b">Requires full container allocation</td>
              </tr>
              <tr>
                <td className="py-3 px-4">Security</td>
                <td className="py-3 px-4">Handled with care (but shared space)</td>
                <td className="py-3 px-4">Higher security (dedicated container)</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <div className="w-full max-w-5xl mt-20 flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="w-full md:w-3/4">
          <h2 className="text-xl md:text-2xl font-semibold text-[#3B409F] mb-2">
      ...
      <div className="w-full max-w-5xl mx-auto mt-20">
        <h2 className="text-center text-2xl md:text-3xl font-semibold text-[#3B409F] mb-12">
      ...
      <div className="w-full max-w-5xl mx-auto mt-20 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        {/* Text Section */}
        <div>
          <h2 className="text-xl md:text-2xl font-semibold text-[#3B409F] mb-4">
          ...
          <p className="text-gray-700 text-sm md:text-base">
            For even smoother shipments, we recommend our air freight services, allowing you to leverage well-informed route analysis and benefit from the skills of our team of professionals to keep your goods moving efficiently. <span className="italic text-gray-400">24/7</span>
          </p>
        </div>
      <div className="w-full mt-16 mb-4">
        <h2 className="text-2xl md:text-3xl font-normal mb-4 text-[#23294d]" style={{ fontFamily: 'Montserrat, sans-serif' }}>
          How does our LCL shipping Cost is calculated?
        </h2>
        <p className="text-gray-600 text-sm md:text-base max-w-2xl" style={{ fontFamily: 'Montserrat, sans-serif' }}>
