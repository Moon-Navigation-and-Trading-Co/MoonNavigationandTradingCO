    ...
    return (
        <>
            <main className="flex-1 flex flex-col gap-20 sm:gap-28 md:gap-36">
                {/* Image and slogan */}
                <section className="relative w-full h-[450px] mt-12">
                    <div className="relative flex items-center rounded-3xl bg-home-image bg-center bg-cover w-full h-full aspect-auto md:aspect-video shadow-black shadow-xl">
                        <div className="w-full h-full z-10 top-0 bg-black-overlay rounded-3xl absolute"></div>
                        <div className="flex md:px-16 px-8 flex-col justify-center z-20 gap-5 max-w-3xl">
                            <h1 className="text-white w-full text-left font-raleway font-regular text-3xl md:text-4xl">{t("slogan")}</h1>
                            <h2 className="font-light text-white text-left text-base md:text-lg max-w-2xl">{t("tagline")}</h2>
                        </div>
                ...
                <section id="about" className="scroll-mt-[80px] px-4 sm:px-6 lg:px-8">
                    <div className="w-full grid md:grid-cols-4 my-12 lg:grid-cols-4 gap-12 lg:gap-28">
                        {/* First Set of Boxes || First Column */}
                        <div className="grid grid-cols-3 md:grid-cols-2 col-span-2 gap-5">
                            <div className="rounded-3xl shadow-md shadow-black bg-primary dark:bg-green-900 aspect-square flex items-center justify-center relative overflow-hidden">
                                ...
                                <h2 className="absolute bottom-4 left-6 text-white text-base md:text-xl font-semibold">{t("aboutImgTitle")}</h2>
                            </div>
                                ...
                                <div className="bg-black shadow-md col-span-1 md:col-span-2 shadow-black rounded-3xl md:max-h-[220px] min-w-full overflow-hidden aspect-square md:aspect-video flex items-center justify-center relative">
                            ...
                            <div ref={modalRef} className="col-span-2 w-full h-full flex flex-col justify-between">
                                <div>
                                    <h2 className="text-4xl font-raleway font-regular pb-12 pt-2 text-foreground">{t("aboutTitle")}</h2>
                                    <p className="text-muted-foreground text-lg pb-12">{t("aboutDescription")}</p>
                                </div>
                    ...
                    <section id="GetQuote" className="w-full flex flex-col items-start justify-center px-4 sm:px-6 lg:px-8 font-raleway">
                      <div className="w-full max-w-8xl flex flex-col md:flex-row items-center justify-between gap-16 mx-auto">
                        {/* Left: Text */}
                        <div className="flex-1 flex flex-col items-start justify-center max-w-2xl">
                          <h2 className="text-4xl leading-tight font-raleway font-regular text-primary mb-4 text-left">Get Your Customized Quote Today</h2>
                          <h3 className="text-2xl font-raleway font-regular text-muted-foreground mb-10 text-left">Effortless Quotation Process—Now Simpler Than Ever!</h3>
                          <p className="text-lg text-muted-foreground mb-6 text-left font-raleway font-light">
                    ...
                    <section className="w-full flex flex-col items-start justify-center px-4 sm:px-6 lg:px-8 font-raleway">
                    ...
                    {/* Contact Section */}
                    <section id="contact" className="scroll-mt-[100px] font-sans px-4 sm:px-6 lg:px-8 pb-20 sm:pb-28 md:pb-36">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                            {/* Left Column: Heading, Description, Address, Meeting Info */}
                            <div className="flex flex-col justify-between h-full">
                                <div>
                                    <h2 className="text-4xl font-raleway font-regular text-primary mb-4">Contact Us</h2>
                                    <p className="text-lg font-raleway font-light text-foreground mb-8 max-w-lg">We are here to provide expert assistance for all your logistics and trading needs. Get in touch with our team for any inquiries.</p>
                                    <div className="flex items-center gap-3 mb-10">
                                        ...
                                        <span className="text-foreground text-base">Port Tawfiq 16a | El-Sawahel St, Suez<br/>Governorate, Egypt</span>
                                    </div>
                                </div>
                                <div className="mt-14">
                                    <p className="text-foreground text-lg font-raleway font-light mb-8 max-w-lg">Alternatively, you can use our online meeting scheduling tool to easily book your preferred time for either a virtual meeting or an in-person meeting with a member of our team. Whether you are looking to discuss partnership opportunities or explore how we can best serve your logistics needs, we are here to help.</p>
                                    <RequestQuoteButton className="w-[240px]" size="lg" type="button">
