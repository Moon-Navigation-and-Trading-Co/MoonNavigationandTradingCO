...
-- Create policy to allow anyone to view error logs (for admin dashboard)
-- You can restrict this later when you have admin roles set up
CREATE POLICY "Allow anyone to view error logs" ON error_logs
