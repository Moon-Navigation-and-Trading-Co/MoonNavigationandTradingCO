...
export default function CarouselAnimation({
  ...
  return (
    ...
    >
      <div className="w-full relative shadow-md overflow-hidden shadow-black h-full lg:w-[160px] rounded-2xl flex items-center justify-start min-w-[180px] flex-shrink-0">
