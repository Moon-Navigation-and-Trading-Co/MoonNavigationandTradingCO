...
export default function CarouselAnimation({
  ...
  return (
    <div
      className={`flex flex-col items-center h-[1600px] md:h-[1400px] w-full max-w-[700px] gap-4 my-16 px-2`}
    >
      <div className="w-full relative shadow-md overflow-hidden shadow-black h-[150px] rounded-2xl flex items-center justify-start">
        ...
        <Image
          ...
          alt="Transportation Services Background"
        />
        <h1 className="text-center z-[105] text-3xl font-semibold text-[#E2F1E7] w-full">
          {title}
        </h1>
      </div>
          ...
          >
            <CardContent className="relative w-full h-full p-0">
              ...
              <div className="absolute w-full h-full bottom-0 left-0 px-2 py-4 text-white">
                {expandedIndex !== index && (
                  <h2 className="text-lg flex text-center justify-start items-end w-full h-full font-semibold">
                    {freight.title}
                  </h2>
                )}
                {expandedIndex === index && (
                  <motion.div
                    ...
                    className="h-full w-full flex p-2 flex-col justify-end  gap-4"
                  >
                    <div>
