...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed right-1/2 translate-x-1/2  top-0 w-[420px] z-[1000] flex max-h-screen flex-col-reverse p-4",
      className
    )}
    {...props}
  />
